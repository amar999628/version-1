...
public class Task {
    ...
    public Task(String taskName, Timestamp taskCreationDateTime, String taskType, Task referencedTask,
                ...
                Timestamp taskExpectedDateTime, Timestamp taskCompletedDateTime, User taskSupervisor,
                String taskRemarks, String taskStatus, Project project, ProjectModule module) {
